...
// @Param	body		body 	models.AccesoHistoria	true		"body for AccesoHistoria content"
// @Success 201 {int} models.AccesoHistoria
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *AccesoHistoriaController) Post() {
	var v models.AccesoHistoria
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddAccesoHistoria(&v); err == nil {
...
// @Success 200 {object} models.AccesoHistoria
// @Failure 404 not found resource
// @router /:id [get]
func (c *AccesoHistoriaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetAccesoHistoriaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *AccesoHistoriaController) GetAll() {
	...
	l, err := models.GetAllAccesoHistoria(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *AccesoHistoriaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.AccesoHistoria{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateAccesoHistoriaById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *AccesoHistoriaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteAccesoHistoria(id); err == nil {

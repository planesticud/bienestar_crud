...
// @Param	body		body 	models.Remision	true		"body for Remision content"
// @Success 201 {int} models.Remision
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *RemisionController) Post() {
	var v models.Remision
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddRemision(&v); err == nil {
...
// @Success 200 {object} models.Remision
// @Failure 404 not found resource
// @router /:id [get]
func (c *RemisionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetRemisionById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *RemisionController) GetAll() {
	...
	l, err := models.GetAllRemision(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *RemisionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Remision{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateRemisionById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *RemisionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteRemision(id); err == nil {

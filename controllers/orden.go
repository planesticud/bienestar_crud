...
// @Param	body		body 	models.Orden	true		"body for Orden content"
// @Success 201 {int} models.Orden
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *OrdenController) Post() {
	var v models.Orden
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddOrden(&v); err == nil {
...
// @Success 200 {object} models.Orden
// @Failure 404 not found resource
// @router /:id [get]
func (c *OrdenController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetOrdenById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *OrdenController) GetAll() {
	...
	l, err := models.GetAllOrden(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *OrdenController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Orden{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateOrdenById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *OrdenController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteOrden(id); err == nil {

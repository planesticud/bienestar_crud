...
// @Param	body		body 	models.SignosVitales	true		"body for SignosVitales content"
// @Success 201 {int} models.SignosVitales
// @Failure 403 body is empty
// @router / [post]
func (c *SignosVitalesController) Post() {
	var v models.SignosVitales
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSignosVitales(&v); err == nil {
...
// @Success 200 {object} models.SignosVitales
// @Failure 403 :id is empty
// @router /:id [get]
func (c *SignosVitalesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSignosVitalesById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *SignosVitalesController) GetAll() {
	...
	l, err := models.GetAllSignosVitales(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *SignosVitalesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.SignosVitales{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateSignosVitalesById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
func (c *SignosVitalesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSignosVitales(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}

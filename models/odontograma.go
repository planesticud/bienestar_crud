...
// AddOdontograma insert a new Odontograma into database and returns
...
// GetOdontogramaById retrieves Odontograma by Id. Returns error if
// Id doesn't exist
...
// GetAllOdontograma retrieves all Odontograma matches certain condition. Returns empty list if
// no records exist
...
// UpdateOdontograma updates Odontograma by Id and returns error if
...
// DeleteOdontograma deletes Odontograma by Id and returns error if

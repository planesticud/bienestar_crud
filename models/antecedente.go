...
// AddAntecedente insert a new Antecedente into database and returns
...
// GetAntecedenteById retrieves Antecedente by Id. Returns error if
// Id doesn't exist
...
// GetAllAntecedente retrieves all Antecedente matches certain condition. Returns empty list if
// no records exist
...
// UpdateAntecedente updates Antecedente by Id and returns error if
...
// DeleteAntecedente deletes Antecedente by Id and returns error if

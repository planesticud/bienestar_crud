...
// AddEspecialidad insert a new Especialidad into database and returns
...
// GetEspecialidadById retrieves Especialidad by Id. Returns error if
// Id doesn't exist
...
// GetAllEspecialidad retrieves all Especialidad matches certain condition. Returns empty list if
// no records exist
...
// UpdateEspecialidad updates Especialidad by Id and returns error if
...
// DeleteEspecialidad deletes Especialidad by Id and returns error if

...
// AddTipoAntecedente insert a new TipoAntecedente into database and returns
...
// GetTipoAntecedenteById retrieves TipoAntecedente by Id. Returns error if
// Id doesn't exist
...
// GetAllTipoAntecedente retrieves all TipoAntecedente matches certain condition. Returns empty list if
// no records exist
...
// UpdateTipoAntecedente updates TipoAntecedente by Id and returns error if
...
// DeleteTipoAntecedente deletes TipoAntecedente by Id and returns error if

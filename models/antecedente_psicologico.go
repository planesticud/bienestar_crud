...
func (t *AntecedentePsicologico) TableName() string {
	return "antecedente_psicologico"
}

func init() {
	orm.RegisterModel(new(AntecedentePsicologico))
}

// AddAntecedentePsicologico insert a new AntecedentePsicologico into database and returns
...
// GetAntecedentePsicologicoById retrieves AntecedentePsicologico by Id. Returns error if
// Id doesn't exist
func GetAntecedentePsicologicoById(id int) (v *AntecedentePsicologico, err error) {
	o := orm.NewOrm()
	v = &AntecedentePsicologico{Id: id}
...
// GetAllAntecedentePsicologico retrieves all AntecedentePsicologico matches certain condition. Returns empty list if
// no records exist
...
// UpdateAntecedentePsicologico updates AntecedentePsicologico by Id and returns error if
// the record to be updated doesn't exist
func UpdateAntecedentePsicologicoById(m *AntecedentePsicologico) (err error) {
	o := orm.NewOrm()
	v := AntecedentePsicologico{Id: m.Id}
...
// DeleteAntecedentePsicologico deletes AntecedentePsicologico by Id and returns error if
...
func DeleteAntecedentePsicologico(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&AntecedentePsicologico{Id: id}); err == nil {

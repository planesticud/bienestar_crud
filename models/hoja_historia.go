...
// GetHojaHistoriaById retrieves HojaHistoria by Id. Returns error if
// Id doesn't exist
...
// GetAllHojaHistoria retrieves all HojaHistoria matches certain condition. Returns empty list if
// no records exist
...
// UpdateHojaHistoria updates HojaHistoria by Id and returns error if
...
// DeleteHojaHistoria deletes HojaHistoria by Id and returns error if
